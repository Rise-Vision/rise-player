...
public class HttpUtils implements HttpConstants {
	...
	public static void printHeaders(File file, ArrayList<String> headers, PrintStream ps) throws IOException {
		if (headers == null) {
			printHeaders(file, ps);
		} else {
	...
	public static boolean printHeaders(File targ, PrintStream ps) throws IOException {
	...
	public static void printHeader_ResponseRedirect(String newUrl, PrintStream ps) {
		...
		printHeader("Location: " + newUrl, ps, true);
	}
